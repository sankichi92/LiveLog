class Admin::AdminsController < AdminController
  def create(member_id)
    ...
    AdminActivityNotifyJob.perform_later(current_user, "メンバー #{user.member.joined_year_and_name} を管理者にしました")
  ...
  def destroy(member_id)
    ...
    AdminActivityNotifyJob.perform_later(current_user, "メンバー #{user.member.joined_year_and_name} の管理者権限を剥奪しました")
